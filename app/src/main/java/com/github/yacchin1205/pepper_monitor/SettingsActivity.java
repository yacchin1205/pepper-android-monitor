...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class ServerPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("fluentd_host"));
            bindPreferenceSummaryToValue(findPreference("fluentd_port"));
        }
    ...
    public static class DataPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("interval_sec"));
            bindPreferenceSummaryToValue(findPreference("tag_prefix"));
        }
